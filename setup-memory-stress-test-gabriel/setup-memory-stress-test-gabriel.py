...
arg_parser.add_argument('--param_mem_per_pod_mb', action='store', type=float, required='True', dest='param_mem_per_pod_mb')
...
import json
filename = "/tmp/pod_chunks_" + id + ".json"
file_pod_chunks = open(filename, "w")
